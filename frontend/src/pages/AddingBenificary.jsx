...
export default function AddingBenificary() {
        ...
        <div className="container">
            <div className="row flex-lg-row-reverse align-items-center justify-content-center g-5 m-3 text-center">
                <form action="" method="post" className="col-12 col-md-8 card p-4 border-0 shadow">
                    ...
                    <h1 className="h3 mb-3 fw-normal">Add a new Benificiary</h1>
                    ...
                    <div className="my-2 text-start">
						<label htmlFor="typeId" className="form-label">
							Enter Benifiacry Account No.
						</label>
                        <input type="text" className="form-control" name="recieverNumber" id="recieverNumber" placeholder="Enter Benificiary Account Number" onChange={handleChange} />
                    </div>

                    <div className="my-2 text-start">
						<label htmlFor="typeId" className="form-label">
							Enter Benifiacry Name
						</label>
                        <input type="text" className="form-control" name="name" id="name" placeholder="Enter Benificiary Name" onChange={handleChange} />
                    </div>

                    <div className="my-2 text-start">
						<label htmlFor="typeId" className="form-label">
							Enter Benifiacry IFSC Code.
						</label>
                        <input type="text" className="form-control" name="ifsc" id="ifsc" placeholder="Enter Benificiary IFSC code" onChange={handleChange} />
                    </div>
